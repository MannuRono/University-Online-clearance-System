...
<body>
    <div class="card">
        ...
        // Retrieve data from the library_cleared table
        $sql = "SELECT * FROM library_cleared";
        $result = $db->query($sql);

        // Check if there are records
        if ($result->num_rows > 0) {
            echo "<h2>Library Cleared Report</h2>";
            echo "<table>";
            ...
            echo "No records found in the library_cleared table.";
        }
