...
<body>
<a href="dean.php" class="home-button">Home</a>
  ...
  <div class="card">
    ...
    <div class="table-container">
      <?php
        ...
        if ($search != '') {
          $sql = "SELECT * FROM dean_clearancerequest WHERE name = '$search'";
        } else {
          $sql = "SELECT * FROM dean_clearancerequest";
        }
        $result = $db->query($sql);
        ...
        if ($result->num_rows > 0) {
          ...
          while($row = $result->fetch_assoc()) {
            ...
            echo '<td><a href="dean_declined.php?id='.$row["regno"].'" class="edit">Decline</a> | <a href="dean_accepted.php?id='.$row["regno"].'" class="edit">Approved</a></td>';
