...
if ($result->num_rows > 0) {
    ...
    $checkQuery = "SELECT * FROM finance_cleared WHERE regno='$regno'";
    ...
    if ($checkResult->num_rows > 0) {
        ...
        $insertQuery = "INSERT INTO finance_declined (regno, name, department, faculty, gender, email) VALUES ('$regno', '$name', '$department', '$faculty', '$gender', '$email')";
