		...
		<nav>
			<ul>
				<li class="manage">
					...
					<ul class="submenu">
						<li><a href="clubs_clearance_request.php">Check clearance request</a></li>
						<li><a href="clubs_declined_report.php">declined clearance reports</a></li>
                        <li><a href="clubs_accepted_report.php">Approved clearance reports</a></li>
