...
<html>
<head>
    <title>Library Cleared Report</title>
    <style>
        /* Card Styles */
        .card {
            position: relative;
...
<body>
    <div class="card">
        ...
        // Retrieve data from the library_declined table
        $sql = "SELECT * FROM library_declined";
        $result = $db->query($sql);

        // Check if there are records
        if ($result->num_rows > 0) {
            echo "<h2>Library declined Report</h2>";
            echo "<table>";
            ...
            echo "No records found in the library_declined table.";
        }
