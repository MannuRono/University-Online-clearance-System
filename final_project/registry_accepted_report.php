...
<body>
    <div class="card">
        ...
        // Retrieve data from the registry_cleared table
        $sql = "SELECT * FROM registry_cleared";
        $result = $db->query($sql);

        // Check if there are records
        if ($result->num_rows > 0) {
            echo "<h2>Registry Cleared Report</h2>";
            echo "<table>";
            ...
            echo "No records found in the registry_cleared table.";
        }
