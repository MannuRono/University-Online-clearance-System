		...
		<nav>
			<ul>
				<li class="manage">
					...
					<ul class="submenu">
						<li><a href="library_clearance_request.php">Check clearance request</a></li>
						<li><a href="library_declined_report.php">declined clearance reports</a></li>
                        <li><a href="library_accepted_report.php">Approved clearance reports</a></li>
